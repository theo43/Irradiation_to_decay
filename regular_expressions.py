...
regex_categ_unit = "concentrations, grams|radioactivity, curies|thermal"
regex_categ_unit += " power, watts|gamma power, watts"

# Regular expression matching groups only
regex_after_Decay = "actinides|fission products|light elements"
